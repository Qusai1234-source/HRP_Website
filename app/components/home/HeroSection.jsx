                    ...
                    <div className="flex items-center min-h-[86vh]">
                        ...
                        <div className="w-full max-w-[600px] pt-10">
                            ...
                            <motion.div {...fadeUp(0.95)} className="flex items-center gap-3 mb-11">
                                ...
                                <span className="font-body text-white/60 text-base tracking-widest uppercase" style={{ letterSpacing: '0.18em', fontSize: '0.8rem' }}>
                            ...
                            <motion.div {...fadeUp(1.1)} className="flex flex-wrap gap-3">
                                ...
                                <a
                                    ...
                                    className="group inline-flex items-center gap-2.5 px-7 py-3.5 border border-brand-accent/60 text-brand-accent font-body font-semibold rounded-lg hover:bg-brand-accent hover:border-brand-accent hover:text-brand-dark transition-all duration-200 text-sm"
                                >
