...
// Leadership · Trusted By · Why HRP · Brands We Carry · CTA
...
const WHY_FEATURES = [
  {
    ...
    desc: "Over four decades of hands-on industrial supply expertise — from hydraulics and rubber engineering to precision instrumentation and pneumatics. Our depth runs further than any catalogue.",
    color: "#2B7EA1",
  },
  {
    Icon: Globe,
    title: "Pan-India Supply Network",
    desc: "From Visakhapatnam to every major industrial hub across India, we maintain a nationwide supply network with reliable logistics and consistent delivery on all stocked items.",
    color: "#8DC63F",
  },
  {
    Icon: ShieldCheck,
    title: "Rigorous Quality Standards",
    desc: "Every product sourced, stored, and supplied through HRP meets stringent industrial quality benchmarks — no compromises, no grey-market sourcing, no shortcuts at any stage.",
    color: "#E11D48",
  },
  {
    Icon: Building2,
    title: "12+ Major Clients",
    desc: "Trusted by organisations across India's most demanding industrial verticals — our client portfolio spans a wide range of applications, each requiring consistent, precision-grade supply.",
    color: "#F59E0B",
  },
  {
    Icon: Users,
    title: "Multi-Generational Leadership",
    desc: "Founded in 1983 and now in its second generation of family leadership, HRP carries forward the values of reliability, quality, and long-term partnership that defined its founding.",
    color: "#A78BFA",
  },
  {
    Icon: MapPin,
    title: "Visakhapatnam's Most Trusted",
    desc: "Rooted in Visakhapatnam since the early 1980s, HRP is the Coromandel Coast's most established industrial supply partner — with the local knowledge and national reach to back it up.",
    color: "#06B6D4",
  },
];
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            {BRANDS.length} brand partners · authorised distribution · certified stock
          </motion.p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            >
              ...
              <em style={{ color: "#8DC63F", fontStyle: "italic" }}>industrial partner you can trust?</em>
            </h2>
            <p className="font-body text-white/55 text-sm leading-relaxed max-w-lg mx-auto mb-10">
              Whether you need a bulk supply arrangement, a specific component sourced, or a long-term
              partnership — our team is ready to assist.
            </p>
            ...
            >
              {[
                ...
                { n: "12+",       l: "Major Clients" },
                { n: "Pan-India", l: "Network" },
                { n: "Est. 1983", l: "Visakhapatnam" },
              ].map((s, i) => (
                <div
                  key={s.l}
            ...
            <p className="font-body text-white/25 text-xs tracking-wide">
              ✓ Same-week quotations &nbsp;&nbsp; ✓ Pan-India delivery &nbsp;&nbsp; ✓ 40+ years of reliability
            </p>
          </motion.div>
        </div>
      </section>
