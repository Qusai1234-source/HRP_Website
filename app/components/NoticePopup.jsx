    ...
    sale: {
        ...
        icon: (
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20 12V22H4V12" /><path d="M2 7h20v5H2z" /><path d="M12 22V7" />
...
export default function NoticePopup() {
        ...
        (async () => {
            try {
                const { data, error } = await supabase
                    .from("notices")
                    .select("id,title,message,type,cta_label,cta_link,image_url,updated_at")
                    .eq("is_active", true)
    ...
    function dismiss() {
        ...
        setTimeout(() => { setVisible(false); setNotice(null); setClosing(false); }, 250);
    }
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {hasImg ? (
                        /* ── IMAGE VARIANT — full-width banner on top, text below ── */
                        <div>
                            {/* Banner image */}
                            <div style={{ position: "relative", width: "100%", height: 220, background: "#0B111A" }}>
                                <img src={notice.image_url} alt=""
                                    style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                                {/* Subtle fade into the content area — bottom 40px only */}
                                <div aria-hidden style={{
                                    position: "absolute", left: 0, right: 0, bottom: 0, height: 40,
                                    background: "linear-gradient(to bottom, transparent, rgba(20,33,51,0.9))",
                                }} />
                                ...
                                <button onClick={dismiss} aria-label="Close notice"
                                    ...
                                    onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(8,13,20,0.8)"; }}
                                    onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(8,13,20,0.55)"; }}
                                >
                            ...
                            {/* Accent divider between image and content */}
                            <div aria-hidden style={{
                                height: 3,
                            ...
                            {/* Content */}
                            <div style={{ position: "relative", padding: "24px 28px 26px", textAlign: "left" }}>
                                ...
                                <p style={{
                                    ...
                                    color: theme.accent, margin: "0 0 8px",
                                }}>
                                    {theme.eyebrow}
                                </p>

                                <h2 id="hrp-notice-title" style={{
                                ...
                                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                                    {hasCTA && (
                                        <a href={notice.cta_link} onClick={dismiss}
                                            style={{
                        ...
                        <>
                            ...
                            <button onClick={dismiss} aria-label="Close notice"
                                style={{
                                    ...
                                    transition: "background 0.15s, color 0.15s", zIndex: 2,
                                }}
                            ...
                            <div style={{ position: "relative", padding: "36px 32px 28px", textAlign: "center" }}>
                                ...
                                <p style={{
                                    ...
                                    color: "rgba(255,255,255,0.65)",
                                    margin: "0 0 26px", whiteSpace: "pre-wrap",
                                }}>
                                    {notice.message}
                                </p>
